...
public class MediaAdapter extends RecyclerView.Adapter<MediaAdapter.MediaViewHolder> {
    ...
    static class MediaViewHolder extends RecyclerView.ViewHolder {
        ...
        MediaViewHolder(View view) {
            ...
            photoThumbnail = view.findViewById(R.id.medium_thumbnail);
        ...
        void bindData(final GalleryActivity mediaActivity, final Medium medium) {
            ...
            final ObjectKey timestampSignature = new ObjectKey(String.valueOf(medium.getTimestamp()));

            Glide.with(mediaActivity)
                    .load(path)
                    .diskCacheStrategy(DiskCacheStrategy.NONE)
                    .signature(timestampSignature)
                    .placeholder(R.color.tmb_background)
                    .centerCrop()
                    .into(photoThumbnail);
